              ...
              <div className="flex-1">
                <div className="text-sm text-yellow-800">
                  <p className="font-medium">
                    {t("location.enableLocationTitle")}
                  </p>
                  <p className="text-xs mt-1">
                    {t("location.enableLocationDesc")}
                  </p>
                </div>
                <Button
                  variant="outline"
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                onClick={() => {
                  document
                    .getElementById("recommendations-dishes")
                    ?.scrollIntoView({
                      behavior: "smooth",
                    });
                }}
        ...
        <div className="container mx-auto px-4">
          ...
          {location.loading ? (
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide">
              {recommendations.dishes.map(
                ({ restaurant, menu, distance }) =>
                  menu && (
                    <DishCard
                      key={menu.id}
                      dishId={menu.id}
                      ...
                      photo={menu.photo}
                      onViewDetails={() =>
                        setSelectedDish({ dish: menu, restaurant })
                      }
                    />
                  )
              )}
      ...
      <section className="py-12 bg-background">
        <div className="container mx-auto px-4">
          <LocationMap
            ...
            restaurants={recommendations.restaurants.map(
              ({ restaurant, distance }) => ({
                id: restaurant.id,
                name: restaurant.name,
                lat: restaurant.lat,
